...
export const Home = () => {
    ...
    return (
        <div className="container mt-5">
            ...
            {!loading && !error && (
                <>
                    <h2 className="text-danger mt-5 mb-3 bg-black d-inline-block px-2 rounded">Characters</h2>
                    ...
                    <h2 className="text-danger mt-5 mb-3 bg-black d-inline-block px-2 rounded">Planets</h2>
                    <div className="d-flex flex-row flex-nowrap overflow-auto pb-4">
                        {planets.map(planet => (
                    ...
                    <h2 className="text-danger mt-5 mb-3 bg-black d-inline-block px-2 rounded">Vehicles</h2>
                    <div className="d-flex flex-row flex-nowrap overflow-auto pb-4">
