...
const ItemCard = ({ item, type }) => {
    ...
    return (
        <div className="card border-dark h-100 text-white" style={{ minWidth: '18rem', maxWidth: '18rem', backgroundColor: '#2c2f33'}}>
            <img
            ...
            <div className="card-body d-flex flex-column">
                ...
                <div className="mt-auto d-flex justify-content-between align-items-center pt-3">
                    <Link to={`/details/${type}/${item.uid}`} className="btn btn-danger">
                        Learn More!
                    </Link>
                    <button
                        className={`btn ${isFavorite ? 'btn-warning' : 'btn-warning'}`}
